...
Security+ certified cybersecurity student finishing my B.S. in Computer Science (Cybersecurity concentration) at Pensacola Christian College in May 2026, followed by an MBA in IT Management. Currently preparing for CySA+.

This repository documents projects, lab work, and writeups across penetration testing, incident response, SIEM, and digital forensics. Targeting SOC analyst, incident response, and junior blue team roles.

## Contact

- **Email:** tcurrier1819@gmail.com
- **LinkedIn:** [linkedin.com/in/travisjcurrier](https://www.linkedin.com/in/travisjcurrier)
- **Location:** East Peoria, IL (open to relocation)

## Certifications

- CompTIA Security+ ce
- CompTIA CySA+ *(in progress — target end of 2026)*
...
**Other:** Technical writing (100+ page operations manual), team leadership, project budgeting
